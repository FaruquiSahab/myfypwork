    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['method'=>'POST', 'action'=> 'TournamentClubController@edit','files'=>true]) !!}
                ...
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <input id="tournaments" type="hidden" value="{{$data->tournament_id}}" name="tournament_id">
                       {{-- <input id="clubs" type="hidden" value="{{$clubs_bracket->club_id}}" name="">
--}}
