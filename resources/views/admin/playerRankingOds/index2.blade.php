...
@section('content')
    ...
    <a style="float: right; margin:10px;" href="{{route('batsmen.point2')}}" class="btn btn-info">Points</a>

    <a style="float: right; margin:10px;" href="{{route('batsmen.sr2')}}" class="btn btn-info">Strike Rate</a>

    <a style="float: right; margin:10px;" href="{{route('batsmen.avg2')}}" class="btn btn-info">Average</a>

    <a style="float: right; margin:10px;" href="{{route('batsmen.runs2')}}" class="btn btn-info">Runs</a>
            ...
            $('#batsmen_table').DataTable(
                {
                    "processing": true,
                    "serverSide": true,
                    "ajax": "{{ route('batsmendatatabes.odi') }}",
                    "columns":[
                        { "data": "points" },
                        { "data": "name" },
                        { "data": "club" },
